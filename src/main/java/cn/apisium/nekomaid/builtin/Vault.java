...
final class Vault {
    ...
    public Vault(NekoMaid main) {
        ...
        main.onConnected(main, client -> client.onWithMultiArgsAck("vault:fetch", args -> {
                ...
                return new Object[] {
                        ...
                        stream.skip(page * 10).limit(10).map(it -> {
                            ...
                            if (permission != null && permission.isEnabled() && permission.hasGroupSupport()) {
                                ...
                                try {
                                    info.groups = permission.getPlayerGroups(null, it);
        ...
        }).onWithAck("vault:setPlayerGroups", args -> {
            ...
            return (boolean) args[2] ? permission.playerAddGroup((World) null, name, group)
                    : permission.playerRemoveGroup((World) null, name, group);
            ...
            return arr;
        }).onWithAck("vault:permission", args -> {
